...
class LoginScreen(Screen):
    ...
    def login_verification(self):
        ...
        if self.ids.email.text == 'cosmos@gmail.com' and self.ids.passw.text == '1234':
            ...
            App.get_running_app().root.current = 'cosmosmenu'
        else:
    ...
    def incorrect_login(self):
        ...
        self.ids.dica.text = 'email = cosmos@gmail.com\nsenha = 1234'  # Mostra qual o login da conta
...
class CosmosHome(Screen):
    # Screen do Menu inicial da Cosmos
...
class ImageContent(Button):
    ...
    # Livros
        if self.image_path == r'Content\Livros\1984.jpg':
            subprocess.run(r'livros\1984.pdf', shell=True)
        if self.image_path == r'Content\Livros\Fahrenheit.jpg':
            subprocess.run(r'livros\Fahrenheit.pdf', shell =True)
        if self.image_path == r'Content\Livros\Harry Potter.jpg':
            subprocess.run(r'livros\harrypotter.pdf', shell=True)
        if self.image_path == r'Content\Livros\O Guia Do Mochileiro das Galáxias.jpg':
            subprocess.run(r'livros\oguia.pdf', shell=True)
        if self.image_path == r'Content\Livros\O Pequeno Príncipe.jpg':
            subprocess.run(r'livros\opequeno.pdf', shell=True)
    # Minha lista
        if self.image_path == r'Content\Minha Lista\2001.jpg':
            subprocess.run(r'livros\odisseia.pdf',shell = True)
        if self.image_path == r'Content\Minha Lista\Código Limpo.jpg':
            subprocess.run(r'livros\codigo.pdf', shell=True)
        if self.image_path == r'Content\Minha Lista\Curso Internsivo De PYTHON.jpg':
            subprocess.run(r'livros\curso.pdf', shell=True)
        if self.image_path == r'Content\Minha Lista\percy.jpg':
            subprocess.run(r'livros\percy.pdf', shell=True)
        if self.image_path == r'Content\Minha Lista\historia.jpg':
            subprocess.run(r'livros\historia.pdf', shell=True)
    # Mais Acessados
        if self.image_path == r'Content\Mais Acessados\cubas.jpg':
            subprocess.run(r'livros\memoriasBras.pdf', shell=True)
        if self.image_path == r'Content\Mais Acessados\poder.jpg':
            subprocess.run(r'livros\poder.pdf', shell=True)
        if self.image_path == r'Content\Mais Acessados\mundo.jpg':
            subprocess.run(r'livros\mundo.pdf', shell=True)         
        if self.image_path == r'Content\Mais Acessados\menina.jpg':
            subprocess.run(r'livros\amenina.pdf', shell=True)
        if self.image_path == r'Content\Mais Acessados\aculpa.jpg':
            subprocess.run(r'livros\aculpa.pdf', shell=True)
    # Revistas e Artigos
        if self.image_path == r'Content\Revistas e Artigos\trilha.jpg':
            subprocess.run(r'livros\trilha.pdf', shell=True)
        if self.image_path == r'Content\Revistas e Artigos\potência.jpg':
            subprocess.run(r'livros\potência.pdf', shell=True)
        if self.image_path == r'Content\Revistas e Artigos\dinossauros.jpg':
            subprocess.run(r'livros\dinossauros.pdf', shell=True)
        if self.image_path == r'Content\Revistas e Artigos\conceito.jpg':
            subprocess.run(r'livros\conceito.pdf', shell=True)
        if self.image_path == r'Content\Revistas e Artigos\tecnologia.jpg':
            subprocess.run(r'livros\tecnologia.pdf', shell=True)
...
class Cosmos(App):
    ...
    cosmos_logo = os.path.join('config', 'cosmos.png')
    background_login = os.path.join('config', 'background.jpg')
    dropmenu_icon = os.path.join('config', 'icone_sair.png')
    ...
    cosmos_font = os.path.join('config', 'net_font.ttf')
